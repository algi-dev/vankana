...
<div class="bg-white p-6 rounded-lg shadow">
    ...
    <form action="{{ route('admin.home.sections.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="button_text" class="w-full border rounded p-2">
        </div>

        <div class="mb-4">
            <label>Link Tombol</label>
            <input type="text" name="button_link" class="w-full border rounded p-2" placeholder="/rooms">
        </div>

        <div class="mb-4">
            <label>URL Gambar</label>
            <input type="text" name="image" class="w-full border rounded p-2" placeholder="/images/home-banner.jpg">
        </div>
